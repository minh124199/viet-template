package io.github.minh124199.viettemplate.vtl.internal.engine.layout;
...
import io.github.minh124199.viettemplate.vtl.interpreter.*;
    ...
    TemplateOutput layoutOutput =
        (output
                ...
                io.github.minh124199.viettemplate.vtl.internal.interpreter.CountingTemplateOutput
                    cto)
            ? cto
            : new io.github.minh124199.viettemplate.vtl.internal.interpreter.CountingTemplateOutput(
                output, budget, layoutId);
    layoutTemplate.render(layoutContext, layoutOutput);
  }

  private static final class BoundedScreenOutput
      extends io.github.minh124199.viettemplate.vtl.internal.interpreter.CountingTemplateOutput {
