...
The latest stable release is **`0.2.2`** (published 2026-09-20). The latest preview release candidate is **`1.0.0-RC2`** (published 2026-09-25). Consumer examples below show the canonical Gradle Plugin DSL resolution (`plugins { id("io.github.minh124199.viet-template") version "1.0.0-RC2" }`), with stable `0.2.2` coordinates also supported.
